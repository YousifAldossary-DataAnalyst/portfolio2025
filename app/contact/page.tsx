        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form
              ...
              ref={formRef?.current}
            >
              <h3 className="text-4xl">Let us work together</h3>
              <p className="text-secondary-foreground/70 flex flex-col gap-4">
                Elevate your business idea. If you have explored the
                projects section, you will see that Degrees offers multiple
