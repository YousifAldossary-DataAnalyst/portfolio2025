                    ...
                    {experience.items.map((item, index) => {
                      return (
                        <CardContainer key={index} className="inter-var">
                          <CardBody className="bg-secondary h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
                            <CardItem
                              as="span"
                              translateZ="50"
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 xl:gap-x-6 max-w-[620px] mx-auto xl:mx-0 py-4">
                  {about.info.map((item, index) => {
                    return (
                      <BackgroundGradient
                        key={index}
                        className="rounded-[22px] h-full w-full py-4 px-2 xl:py-0 xl:px-0 xl:p-4 bg-white dark:bg-zinc-900"
                      >
