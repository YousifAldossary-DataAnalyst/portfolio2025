      ...
      <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
        <div className="max-w-lg">
          <h2 className="max-w-lg text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
            In the last 2 years, I have worked alongside Astro to create this approach.
          </h2>
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            The goal is to create 4 websites to cover the basic needs. 3/4 websites are 75% done. Only the most important one remains that is Micro job market place.
          </p>
        </div>
        <Image
